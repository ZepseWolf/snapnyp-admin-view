 $(document).ready(function() {
        ...
        init_multifield(10, '.input_fields_wraps', '.add_field_button', 'user_music[]');
        ...
        function init_multifield(max, wrap, butt, fname_p) {
            ...
            $(add_button).click(function (e) { //on add input button click
                ...
                if (x < max_fields) { //max input box allowed
                    ...
                    var cstring = '$(wrapper).append(\'<div style=""><input class="fields" type="text" placeholder="Themes" name=' + fname + '><a href="#" class="remove_field">Remove</a></div>\');' //add input box
                    eval(cstring);
                }
            });
